...
public class DLNode<T>
    ...
    /**
     * convenience method - generates a {@code String} representation of a chain of {@code DLNode}s
     * traversed along its {@code next} references without positions
     * <p>
     * I provided this as a debugging aid
     *
     * @param firstNode
     *     the starting point for the chain, typically {@code this.firstNode} (or similar) from the
     *     collection
     *
    ...
    /**
     * convenience method - generates a {@code String} representation of a chain of {@code DLNode}s
     * traversed via the specified (true: next; false: previous) references without positions
     * <p>
     * I provided this as a debugging aid
     *
     * @param firstNode
     ...
     *     flag to traverse the chain by following next references (true) or previous references
     *     (false)
     *
     * @return a text representation of the chain of {@code DLNode}s
     */
     ...
     * I provided this as a debugging aid
     * <p>
     * NOTE: traversing the chain backwards and including the positions counts the index starting
     * with startNode as zero (0) and subsequent nodes appear as negative indices
     *
     * @param startNode
     *     the starting point for the chain, typically {@code firstNode} from the collection if
     *     traversing along {@code this.next} references, otherwise {@code lastNode} if traversing
     *     along {@code this.previous} references
     * @param forwardTraversal
     *     flag to traverse the chain by following next references (true) or previous references
     *     (false)
     * @param includePosition
     *     flag to include (true) or omit (false) each DLNode's position starting with the first
     *     DLNode in the chain - each position is equivalent to the index in a corresponding
     *     array-backed collection<br>
    ...
    public static String chainToString( final DLNode<?> startNode,
        ...
        while ( currentNode != null )
            ...
            if ( forwardTraversal )
                ...
                {
                result.insert( 0,
                               " " + BIDIRECTIONAL_SIBLING_REFERENCE_MARKER +
                                  " " ) ;
                }
    ...
    public static void main( final String[] args )
        ...
        System.out.printf( "instantiate first node: %s%n%n",
                           newNode.toString() ) ;
        ...
        // second element
        final DLNode<String> bNode = newNode = new DLNode<>( lastNode,
                                                             "B",
                                                             null ) ;
        lastNode.next = newNode ;
        lastNode = newNode ;

        System.out.printf( "instantiate second node at end of chain: %s%n%n",
                           newNode.toString() ) ;
        ...
        // third element
        final DLNode<String> cNode = newNode = new DLNode<>( lastNode,
                                                             "C",
                                                             null ) ;
        lastNode.next = newNode ;
        lastNode = newNode ;

        System.out.printf( "instantiate third node at end of chain: %s%n%n",
                           newNode.toString() ) ;
        ...
        // fourth element
        final DLNode<String> dNode = newNode = new DLNode<>( lastNode,
                                                             "D",
                                                             null ) ;
        lastNode.next = newNode ;
        lastNode = newNode ;

        System.out.printf( "instantiate fourth node at end of chain: %s%n%n",
                           newNode.toString() ) ;
        ...
        final DLNode<String> eNode = newNode = new DLNode<>( null,
                                                             "E",
                                                             firstNode ) ;
        firstNode.previous = newNode ;
        firstNode = newNode ;

        System.out.printf( "instantiate fifth node at beginning of chain: %s%n%n",
                           newNode.toString() ) ;
    ...
    /**
     * Display forward and backward traversals of a chain given its first and last nodes and
     * descriptive labels
     *
