...
package edu.wit.scds.ds.common.chains.basic ;

/**
 * Class {@code Node} provides the basis for singly-linked chain functionality<br>
 * based on material from Carrano and Henry's "Data Structures and Abstractions with Java", 4th
 * edition and from the JCL
 *
 ...
 *     <li>rename the parameter for the 1-arg constructor which takes a data reference to be
...
public final class Node<T>
     ...
     */
    public Node( final T initialData, final Node<T> nextNode )
        {
